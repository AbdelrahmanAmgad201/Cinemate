                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <StatCard title="Change Password">
                            ...
                            <div className="input-elem">
                                ...
                                <div className="icon-input">
                                    <HiOutlineLockClosed />
                                    <input type={showConfirmPassword ? "text" : "password"} id="confirmPassword" name="confirmPassword" minLength={MIN_LENGTHS.PASSWORD} maxLength={MAX_LENGTHS.INPUT} placeholder="Enter New Password" onChange={(e) => setConfirmPassword(e.target.value)}/>
